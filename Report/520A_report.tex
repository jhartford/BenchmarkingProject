...
%
%
%>>>>>>> adc9c218923d1b7332eb4a0a664cb2adf45e497a
...
This suggests that in practice one could sample fewer particles using the SMC sampler to achieve similar performance to MCMC. While this allows SMC to match MCMC, it does not sure a clear advantage in simple one dimensional cases.
